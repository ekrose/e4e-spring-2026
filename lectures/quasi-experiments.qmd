...
## Example: George Floyd and police violence

Bruhn (2023) studied what happened to police killings after George Floyd's murder in May 2020.
...
**The question:** Did this attention actually reduce police killings?

---

## What the data showed

![](images/george-floyd-time-series.svg){fig-align="center" width="80%"}

---

## Interpreting the results

Police killings fell significantly after the event.
...
- Assumes the trend would have continued
- No control group to benchmark against
...
The Affordable Care Act allowed states to expand Medicaid coverage.

. . .

Some states expanded in 2014, others did not.
...
::: {.notes}
Miller et al. (2021). "Medicaid and Mortality: New Evidence from Linked Survey and Administrative Data." Quarterly Journal of Economics.
:::
...
Compare changes in mortality rates before and after 2014.
...
Approximately **1 death prevented per 1,300 people covered**.
...
- Middle-aged adults
- People with treatable conditions
- Counties with higher pre-existing uninsurance

::: {.notes}
Miller, Johnson, and Wherry (2021). "Medicaid and Mortality: New Evidence from Linked Survey and Administrative Data." Quarterly Journal of Economics.
:::
