...
![](images/klevin_beckham_law_graph.png){fig-align="center" width="85%"}

::: {style="text-align: center; font-size: 0.6em; margin-top: -10px;"}
<span style="color: black;">— Spain</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span style="color: black;"> – – Other countries</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span style="color: red;">— ΔTop tax rate</span>
:::

::: {.notes}
Graph is from Kleven, Landais & Saez (2013).
:::
